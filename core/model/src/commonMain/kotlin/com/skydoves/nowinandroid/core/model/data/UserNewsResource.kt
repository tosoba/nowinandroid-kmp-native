...
/**
 * A [NewsResource] with additional user information such as whether the user is following the news
 * resource's topics and whether they have saved (bookmarked) this news resource.
 */
@Immutable
...
fun List<NewsResource>.mapToUserNewsResources(userData: UserData): List<UserNewsResource> = map {
