...
internal fun BookmarksScreen(
  ...
  val bookmarkRemovedMessage = stringResource(BookmarksApiRes.strings.feature_bookmarks_api_removed)
...
private fun LoadingState(modifier: Modifier = Modifier) {
  NiaLoadingWheel(
    modifier = modifier.fillMaxWidth().wrapContentSize().testTag("bookmarks:loading"),
...
private fun BookmarksGrid(
  ...
  Box(modifier = modifier.fillMaxSize()) {
    LazyVerticalStaggeredGrid(
      ...
      modifier = Modifier.fillMaxSize().testTag("bookmarks:feed"),
    ) {
      newsFeed(
        feedState = feedState,
    ...
    scrollableState.DraggableScrollbar(
      ...
      onThumbMoved = scrollableState.rememberDraggableScroller(itemsAvailable = itemsAvailable),
    )
  }
}
...
private fun EmptyState(modifier: Modifier = Modifier) {
  Column(
    modifier = modifier.padding(16.dp).fillMaxSize().testTag("bookmarks:empty"),
